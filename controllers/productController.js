...
const filterProductController = async(req,res)=>{
  try {
    ...
    res.status(200).send({
      success:true,
      message:"products save successfull",
      products,
    })
  } catch (error) {
    console.log(error)
...
const productListController = async(req,res)=>{
  try {
    ...
    res.status(200).send({
      success:true,
      message:"product list getting successfull",
      products
    })
  } catch (error) {
    console.log(error),
...
try {
  ...
  res.status(500).send({
    success:false,
    message:"Error while getting search product",
    error
  })
}
}

//similer related product controller
const relatedProductController = async(req,res)=>{
  try {
    ...
    res.status(500).send({
      success:false,
      message:"error while getting similer product",
      error
    })
  }
}
